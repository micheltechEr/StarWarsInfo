const urlStarWar = "https://swapi.py4e.com/api/";
...
var personName, person, card;

function getElement(element) {
    //Função para pegar o elemento HTML(id ou class)
...
function requestPersonInfo(url, nameP) {
    fetch(url + nameP) //O fetch tem como argumento a url e o nome do pokemon,realizando uma concatenação
        ...
        .then((data) => {
            person = data;
        }) //Recebe a resposta e coloca  em uma variavel
